...
/**
 * Servlet implementation class InquiresAPI
 */
@WebServlet("/InquiresAPI")
public class InquiresAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = inquiryObj.insertInquiries(request.getParameter("inquiryID"), 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 String output = inquiryObj.updateInquiry(paras.get("inquiryID").toString(), 
